...
Vite + React + Tailwind playground to test **react-maestro** locally. Uses the full test wizard with branching logic. Not part of the published package.
...
- **react-maestro** – consumed via `file:..` (parent directory). Not a published dependency.
